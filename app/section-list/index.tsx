      ...
      <ThemedCard>
        <SectionList
          ...
          renderSectionHeader={({ section })=>(
            <ThemedText type='h1' className='bg-light-background dark:bg-dark-background p-2 rounded'>{section.title}</ThemedText>
          )}
          ...
          ListFooterComponent={()=>(
            <ThemedText
              type='h1'
              className='font-bold mb-3 mt-3 bg-light-background dark:bg-dark-background p-2 mb-10 rounded'
            >
